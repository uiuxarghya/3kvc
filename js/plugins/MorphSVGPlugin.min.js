  ...
  var a = Math.PI / 180,
    ...
    q = function (a) {
      for (
        ...
        for (f = a[g], b = f.length, e = 6; e < b; e += 6)
          (c = f[e]),
            (d = f[e + 1]),
            c > h ? (h = c) : c < i && (i = c),
            d > j ? (j = d) : d < k && (k = d);
    ...
    v = function (a, b, c) {
      var d,
        ...
        m = 0;
      for (f = 6; f < g; f += 6)
        (e = u(a, b, f / 6, j, k)), e < l && ((l = e), (m = f));
      if (c)
        for (d = a.slice(0), n(d), f = 6; f < g; f += 6)
          (e = u(d, b, f / 6, j, k)), e < l && ((l = e), (m = -f));
      return m / 6;
    },
    w = function (a, b, c) {
      for (
        ...
        for (d = a[j], i = d.length, h = 0; h < i; h += 6)
          (e = d[h] - b),
            (f = d[h + 1] - c),
            (g = Math.sqrt(e * e + f * f)),
            g < k && ((k = g), (l = d[h]), (m = d[h + 1]));
      return [l, m];
    },
    x = function (a, b, c, d, e, f) {
      var g,
        ...
        q = a.centerX + e,
        r = a.centerY + f;
      for (h = c; h < l && ((g = b[h].size || p(b[h])), !(g < n)); h++)
        (i = b[h].centerX - q),
          (j = b[h].centerY - r),
          (k = Math.sqrt(i * i + j * j)),
          k < o && ((m = h), (o = k));
    ...
    J = _gsScope._gsDefine.plugin({
      ...
      init: function (a, b, c, d) {
        ...
        return (
          ...
          "PATH" === f || k
            ? ((g = "PATH" === f ? "d" : "points"),
              ("string" == typeof b || b.getBBox || b[0]) && (b = { shape: b }),
              ...
              k && e.test(j)
                ...
                : (j &&
                    ...
                    i &&
                      ...
                      (i.endProp = g))),
                  !0))
            : (h("WARNING: cannot morph a <" + f + "> SVG element. " + I), !1))
        );
      },
      set: function (a) {
        var b;
